...
ACTIVE_CONFIG_KEYS = frozenset(
    {
        ...
        "alerts.policy_variant",
        "alerts.regime_overrides.Transition.RR_EXTREME.min_abs_zscore",
        "alerts.regime_overrides.Transition.FLY_EXTREME.min_abs_zscore",
        "alerts.regime_overrides.Calm.RR_EXTREME.min_abs_zscore",
        "alerts.regime_overrides.Calm.FLY_EXTREME.min_abs_zscore",
        "alerts.regime_overrides.Stress.RR_EXTREME.min_abs_zscore",
        "alerts.regime_overrides.Stress.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Transition.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Transition.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Calm.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Calm.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Stress.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2a.regime_overrides.Stress.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Transition.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Transition.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Transition.disabled_alert_types",
        "alerts.policy_variants.v2b.regime_overrides.Calm.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Calm.FLY_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Stress.RR_EXTREME.min_abs_zscore",
        "alerts.policy_variants.v2b.regime_overrides.Stress.FLY_EXTREME.min_abs_zscore",
        ...
        "alerts.lifecycle.require_full_tier_for_execution",
        "qc.no_arb_epsilon",
        ...
        "regime.score_calm_max",
        "regime.score_stress_min",
...
CONTRACT_TEST_COVERAGE: dict[str, tuple[str, ...]] = {
    ...
    "regime.score_calm_max": ("tests/test_regime.py",),
    "regime.score_stress_min": ("tests/test_regime.py",),
