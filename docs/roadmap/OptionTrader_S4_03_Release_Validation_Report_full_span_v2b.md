...
Generated at: 2026-05-22T02:42:35.362095Z
...
```json
{
  ...
  "generated_at": "2026-05-22T02:42:35.362095Z",
  "independence_diagnostics": {
    "baseline": {
      "contribution_shares": {
        "drawdown": 0.0,
        "event": 0.0,
        "rv20": 0.5205559906029757,
        "stress_proxy": 0.0,
        "vix": 0.47944400939702425
      },
  ...
  "threshold_freeze": {
    ...
    "blocked_reasons": [],
    "candidate_config_hash": "2521728f713d993f8f7688b18f3cdb1229dd5681a415e7b3ce02446f8b9db7f4",
...
python scripts/validate_release.py --config-path config/config-eod-truth.yaml --start-ts 2010-01-01T00:00:00Z --end-ts 2023-12-31T23:59:59Z --underlying SPX --baseline-lineage 3b024c9 --candidate-lineage 5128e8e-v2b --train-size 252 --test-size 63 --step-size 63 --horizon-days 5
```
