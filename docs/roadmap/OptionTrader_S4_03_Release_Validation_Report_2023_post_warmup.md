...
Generated at: 2026-05-18T06:36:19.237786Z
...
- Walk-forward deterministic gate: FAIL
...
- Effective start: `2023-01-01T00:00:00Z`
...
```json
{
  ...
  "generated_at": "2026-05-18T06:36:19.237786Z",
  "independence_diagnostics": {
    "baseline": {
      "contribution_shares": {
        "drawdown": 0.08631071858691294,
        "event": 0.0,
        "rv20": 0.363307908470494,
        "stress_proxy": 0.23926134082697667,
        "vix": 0.3111200321156164
      },
      "correlation_stress_vs_rv20": 0.7062073881783825,
...
python scripts/validate_release.py --config-path config/config-eod-truth.yaml --start-ts 2023-01-01T00:00:00Z --end-ts 2023-12-31T23:59:59Z --underlying SPX --baseline-lineage 3b024c9 --candidate-lineage 5128e8e --train-size 252 --test-size 63 --step-size 63 --horizon-days 5
```
