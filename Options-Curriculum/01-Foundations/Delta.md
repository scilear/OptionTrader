...
This relationship is exact in the [[Black-Scholes Model]] and holds empirically across liquid markets. It breaks down slightly for very short-dated or illiquid options, but remains a reliable trader's rule of thumb.
...
This relationship underlies [[put-call parity]] and is why market makers delta-hedge continuously.

## Key Takeaways

- Delta is directional exposure and the hedge ratio.
- Delta ≈ probability of expiring ITM (under [[Black-Scholes Model|Black-Scholes]] assumptions).
